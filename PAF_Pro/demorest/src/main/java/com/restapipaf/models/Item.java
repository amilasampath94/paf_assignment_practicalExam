...
public class Item {
	public String getItems() {
		...
		try {
			...
			rs = st.executeQuery("select * from restdb");

			if (rs.first()) {
				itemsGrid = "<table border='1' cellspacing='1' cellpadding='1'><tr>"
						+ "<th>No</th><th>Name</th><th>Description</th>" + "<th>Edit</t h><th>Delete</th></tr>";
				...
				rs.beforeFirst();
				{
					...
					itemsGrid = itemsGrid + "<tr><td>" + rs.getString(1) + "</td>"
							...
							+ rs.getString(1) + "\" value=\"Edit\"</td>" + "<td>"
							+ "<input id=\"btnRemove\" type=\"button\"" + " name=\"btnRemove\" param=\""
